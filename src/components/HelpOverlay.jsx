    ...
    <div className='help-overlay' role='dialog' aria-modal='true'>
      <div className='help-box'>
        ...
        <ul>
          ...
          <li>
            Export as a C array or a .h file for direct inclusion in Arduino
            sketches.
          </li>
          <li>
            Use the Send button to upload frames via Web Serial (you'll be asked
            to confirm).
          </li>
        </ul>
          ...
          <div className='help-right'>
            ...
            <div className='help-media'>
              <div className='media-placeholder'>
                Drop screenshots or GIFs here (or open devtools and paste)
              </div>
            </div>
            <p className='muted'>
              Add images to the repo under <code>/assets/help/</code> and
              reference them here if you want inline visuals.
            </p>
          </div>
        </div>
